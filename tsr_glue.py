...
def parse_args():
    ...
    parser.add_argument("--lora_r_emb", type=int, default=8)
    ...
    # support enable_tsr
    parser.add_argument("--enable_tsr", action="store_true", help="Whether or not to use low rank optimizer.")
    # update_proj_gap
    ...
    # proj_type_emb
    parser.add_argument("--proj_type_emb", type=str, default="std")
    # lora_all_modules
...
def main():
    ...
    if not args.enable_tsr:
        optimizer = torch.optim.AdamW(optimizer_grouped_parameters, lr=args.learning_rate)
    else:
        from torch import nn
        # label layers for tsr optimizer
        ...
        param_groups = [{'params': regular_params}, 
                        {'params': tsr_params, 'rank': args.lora_r, 'update_proj_gap': args.update_proj_gap, 'scale': args.tsr_scale, 'proj_type': args.proj_type},
                        {'params': embedding_params, 'rank': args.lora_r_emb, 'update_proj_gap':args.update_proj_gap_emb, 'scale':args.tsr_scale_emb, 'proj_type':args.proj_type_emb, 'embedding':True}]
        optimizer = TSRAdamW(param_groups, lr=args.learning_rate)
